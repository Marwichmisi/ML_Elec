...
**Verification depth scales with `asvs_level`** (see @/home/marwane/Documents/My-ML_Elec/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
