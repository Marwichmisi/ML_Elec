...
**Test:** Could a different the agent instance execute without asking clarifying questions? If not, add specificity. See @/home/marwane/Documents/My-ML_Elec/.codex/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.
