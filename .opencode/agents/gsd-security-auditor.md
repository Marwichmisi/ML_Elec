...
**Verification depth scales with `asvs_level`** (see @/home/marwane/Documents/My-ML_Elec/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
