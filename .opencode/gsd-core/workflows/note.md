...
- **Global scope**: `/home/marwane/Documents/My-ML_Elec/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/marwane/Documents/My-ML_Elec/.opencode/notes/`)
...
2. Glob `/home/marwane/Documents/My-ML_Elec/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/marwane/Documents/My-ML_Elec/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/marwane/Documents/My-ML_Elec/.opencode/notes/` — works in any directory
