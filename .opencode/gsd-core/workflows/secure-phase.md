...
```
Agent(
  prompt="Read /home/marwane/Documents/My-ML_Elec/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/marwane/Documents/My-ML_Elec/.opencode/gsd-core/templates/SECURITY.md`
