...
INSTALL_JS_GLOBAL="/home/marwane/Documents/My-ML_Elec/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/marwane/Documents/My-ML_Elec/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
