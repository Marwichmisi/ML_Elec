...
- [x] **Phase 2: Plugin SDK & MQTT Bridge** - Versioned plugin contracts and Python MQTT plugin bridging ESP32 sensors to NATS (completed 2026-07-03)
...
- [x] 02-02-PLAN.md — Config extensions + asset registry migrations & CRUD
...
- [x] 02-06-PLAN.md — Gap closure: NATS publishing, validation, storage, QoS, backoff
...
| 2. Plugin SDK & MQTT Bridge | 5/5 | ✓ Complete | 2026-07-03 |
